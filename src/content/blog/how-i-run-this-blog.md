---
title: How I run (ran) this blog
slug: how-i-run-this-blog
description: A description for others, but primarily myself, of how I update, run, and host this blog (outdated).
...
topics:
  ...
  - Tutorial
  - GitHub Pages
heroImage: editorial/github-image.png
featured: false
legacyPaths:
  - /how-i-run-this-blog/
---
#### Note: this guide was written when the blog was based on Jekyll. It is now built on Astro (which is way better!)
